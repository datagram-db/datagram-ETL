...
#include "test_hashstrategy_class.h"
#include "../src/graphs/LoadingGraph.h"
#include "../src/sorting/HashStrategy.h"
...
void test_hashstrategy_class() {
    ...
    std::string offset_map_file{"offset_map_file.tmp"};
    {
        ...
        HashStrategy test{loadingGraph, adj_list_strategy, vertex_hash_strategy, vset_primary_memory};
        {
