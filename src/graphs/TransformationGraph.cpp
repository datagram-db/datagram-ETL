...
TransformationGraph::TransformationGraph(bool primary_memory) : in_edges{primary_memory}, out_edges{primary_memory}, is_strategy_primary_memory{primary_memory} {}
