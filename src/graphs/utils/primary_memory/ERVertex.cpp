...
entity_relationship::entity_relationship() : entity_relationship(0,0) {}

entity_relationship::entity_relationship(LONG_NUMERIC id, LONG_NUMERIC hash) : id{id}, hash{hash} {}
