...
vertex_id_index::vertex_id_index(LONG_NUMERIC id, LONG_NUMERIC hash, LONG_NUMERIC offset) : id(id), hash(hash), offset(offset) {}

vertex_id_index::vertex_id_index() : vertex_id_index{0,0,0} {}
